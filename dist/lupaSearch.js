...
const unfoldTermFilter = (key, filter) => {
  const seed = [];
  return filter.reduce((a, c2) => [...a, { key, value: c2, type: "terms" }], seed);
};
...
const flattenSuggestionFacet = (suggestion, suggestionFacets, inputValue) => {
  ...
  const facetSuggestions = facets.reduce(
    (a, c2) => [...a, ...flattenFacet(c2.key, c2.value, suggestion, inputValue)],
    seed
  );
...
const useSearchBoxStore = defineStore("searchBox", () => {
  const options = vue.ref(DEFAULT_SEARCH_BOX_OPTIONS);
  const docResults = vue.ref({});
  ...
  const panelItemCounts = vue.computed(
  ...
  const hasAnyResults = vue.computed(() => {
    var _a;
  ...
  const totalCount = vue.computed(
    () => {
      var _a, _b;
      return resultsVisible.value ? (_b = (_a = panelItemCounts.value) == null ? void 0 : _a.reduce((a, c2) => a + c2.count, 0)) != null ? _b : 0 : historyStore.count;
    }
  );
  const highlightedItem = vue.computed(() => {
    let i = 0;
  ...
  const highlightedDocument = vue.computed(() => {
    var _a, _b;
  ...
  const querySuggestions = (_0) => __async(exports, [_0], function* ({
    queryKey,
    publicQuery,
    options: options2
  }) {
  ...
  const queryDocuments = (_0) => __async(exports, [_0], function* ({
    queryKey,
    publicQuery,
    options: options2
  }) {
...
const _sfc_main$14 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    const emit = __emit;
    const mainInput = vue.ref(null);
    const emitInputOnFocus = vue.computed(() => {
      var _a;
      return (_a = props.emitInputOnFocus) != null ? _a : true;
    });
    const suggestedValue = vue.computed(
      () => {
        var _a;
        return (_a = props.suggestedValue) != null ? _a : { value: "", override: false, item: { suggestion: "" } };
      }
    );
    const labels = vue.computed(() => props.options.labels);
    const input = vue.ref("");
    ...
    const inputAttributes = vue.computed(() => {
      var _a;
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("a", {
        ...
        onClick: handleClick
      }, vue.toDisplayString(_ctx.labels.moreResults) + " " + vue.toDisplayString(totalCount.value), 1);
    };
  }
});
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$Z, [
        vue.createElementVNode("div", _hoisted_2$G, [
          vue.createElementVNode("div", {
            ...
            onClick: click2
          }, vue.toDisplayString(_ctx.item), 3),
          vue.createElementVNode("div", {
...
const _sfc_main$11 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emit = __emit;
    const highlightIndex = vue.computed(() => {
      var _a;
      return (_a = highlightedIndex.value) != null ? _a : -1;
    });
    const hasHistory = vue.computed(() => history.value && history.value.length > 0);
    vue.onMounted(() => {
    ...
    return (_ctx, _cache) => {
      return hasHistory.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$Y, [
        ...
        vue.createElementVNode("div", {
          ...
          onClick: removeAll
        }, vue.toDisplayString(_ctx.options.labels.clear), 1)
      ])) : vue.createCommentVNode("", true);
    };
  }
});
...
const _sfc_main$10 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("p", _hoisted_1$X, vue.toDisplayString(_ctx.labels.noResults), 1);
    };
  }
});
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        _ctx.highlight ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
          class: "lupa-suggestion-value",
          "data-cy": "lupa-suggestion-value",
          innerHTML: _ctx.suggestion.displayHighlight
        }, null, 8, _hoisted_1$W)) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$F, vue.toDisplayString(_ctx.suggestion.display), 1)),
...
const _sfc_main$Y = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const rootImageUrl = vue.computed(() => props.options.baseUrl);
    const image = vue.computed(() => props.item[props.options.key]);
    const hasFullImageUrl = vue.computed(() => {
    ...
    const hasImage = vue.computed(() => Boolean(hasFullImageUrl.value || image.value));
    const placeholder = vue.computed(() => props.options.placeholder);
    const finalUrl = vue.computed(() => {
...
const _sfc_main$W = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return isHtml.value ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        class: "lupa-search-box-product-title",
        innerHTML: title.value
      }, null, 8, _hoisted_1$T)) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$E, [
...
const _sfc_main$V = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      }, null, 8, _hoisted_1$S)) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$D, vue.toDisplayString(description.value), 1));
    };
  }
});
...
const _sfc_main$T = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$Q, vue.toDisplayString(price.value), 1);
    };
  }
});
...
const _sfc_main$S = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const text = vue.computed(() => props.item[props.options.key]);
    const className = vue.computed(() => props.options.className);
    const label = vue.computed(() => props.options.label);
    const isHtml = vue.computed(() => {
      var _a;
      return (_a = props.options.isHtml) != null ? _a : false;
    });
    ...
    return (_ctx, _cache) => {
      return isHtml.value ? (vue.openBlock(), vue.createElementBlock("div", vue.mergeProps({
        key: 0,
        ...
        !label.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$C, vue.toDisplayString(text.value), 1)) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$t, [
          vue.createElementVNode("div", _hoisted_4$l, vue.toDisplayString(label.value), 1),
          vue.createElementVNode("div", _hoisted_5$c, vue.toDisplayString(text.value), 1)
        ]))
      ], 16));
    };
  }
...
const _sfc_main$R = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const text = vue.computed(() => props.options.html(props.item));
    const className = vue.computed(() => props.options.className);
    const handleClick = () => __async(this, null, function* () {
      if (!props.options.action) {
        return;
...
const _sfc_main$P = /* @__PURE__ */ vue.defineComponent(__spreadProps(__spreadValues({}, __default__$2), {
...
const _sfc_main$L = /* @__PURE__ */ vue.defineComponent(__spreadProps(__spreadValues({}, __default__$1), {
  ...
  setup(__props, { emit: __emit }) {
    const props = __props;
    const panelContainer = vue.ref(null);
    ...
    const displayHistory = vue.computed(
      () => {
        var _a;
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        displayResults.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$K, [
          vue.createElementVNode("div", {
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(displayPanels.value, (panel, index) => {
              ...
              return vue.openBlock(), vue.createElementBlock("div", {
                ...
                ((_a2 = panel.labels) == null ? void 0 : _a2.topResultsTitle) && showTopResultsPanelTitle(panel.queryKey) ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$q, vue.toDisplayString((_b = panel.labels) == null ? void 0 : _b.topResultsTitle), 1)) : vue.createCommentVNode("", true),
          ...
          !vue.unref(hasAnyResults) && _ctx.options.showNoResultsPanel ? (vue.openBlock(), vue.createBlock(_sfc_main$10, {
            key: 0,
            labels: labels.value
          }, null, 8, ["labels"])) : vue.createCommentVNode("", true),
          vue.unref(hasAnyResults) || !_ctx.options.hideMoreResultsButtonOnNoResults ? (vue.openBlock(), vue.createBlock(_sfc_main$13, {
            key: 1,
            labels: labels.value,
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$J, [
        vue.createElementVNode("div", _hoisted_2$y, [
          ...
          opened.value || _ctx.isSearchContainer ? (vue.openBlock(), vue.createBlock(_sfc_main$L, {
            key: 0,
            ...
            _ctx.$slots.productCard ? {
              name: "productCard",
              fn: vue.withCtx((props2) => [
                vue.renderSlot(_ctx.$slots, "productCard", vue.normalizeProps(vue.guardReactiveProps(slotProps(props2))))
              ]),
              key: "0"
            } : void 0
          ]), 1032, ["options", "inputValue", "isSearchContainer"])) : vue.createCommentVNode("", true)
        ])
      ]);
    };
  }
...
const _sfc_main$J = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const didYouMeanValue = vue.computed(() => {
      var _a;
    ...
    return (_ctx, _cache) => {
      return vue.unref(searchResult).suggestedSearchText || didYouMeanValue.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$I, [
        vue.unref(searchResult).suggestedSearchText ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$x, [
          (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.labels.noResultsSuggestion.split(" "), (label, index) => {
            return vue.openBlock(), vue.createElementBlock("span", { key: index }, [
              vue.createElementVNode("span", {
                class: vue.normalizeClass(getStyle(label))
              }, vue.toDisplayString(insertValue(label)) + " ", 3)
            ]);
          }), 128))
        ])) : vue.createCommentVNode("", true),
...
const _sfc_main$I = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const summaryLabel = vue.computed(() => {
      const range = itemRange.value.join("-");
      return addParamsToLabel(props.label, range, `<span>${totalItems.value}</span>`);
    });
    return (_ctx, _cache) => {
      return vue.unref(totalItems) > 0 ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$H, [
        vue.createElementVNode("div", { innerHTML: summaryLabel.value }, null, 8, _hoisted_2$w),
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", null, [
        showSearchTitle.value ? (vue.openBlock(), vue.createElementBlock("h1", _hoisted_1$G, [
          vue.createTextVNode(vue.toDisplayString(_ctx.options.labels.searchResults), 1),
          queryText.value ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$v, "'" + vue.toDisplayString(queryText.value) + "'", 1)) : vue.createCommentVNode("", true),
        ...
        _ctx.showSummary ? (vue.openBlock(), vue.createBlock(_sfc_main$I, {
          key: 1,
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$F, [
        ...
        vue.createElementVNode("div", _hoisted_2$u, vue.toDisplayString(_ctx.filter.label) + ": ", 1),
...
const _sfc_main$F = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      var _a, _b, _c, _d, _e, _f;
      return hasFilters.value ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        class: vue.normalizeClass(["lupa-search-result-current-filters", { expandable: _ctx.expandable }]),
        ...
        vue.createElementVNode("div", {
          ...
          vue.createElementVNode("div", _hoisted_1$E, [
            ...
            _ctx.expandable ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2$t, " (" + vue.toDisplayString(vue.unref(currentFilterCount)) + ") ", 1)) : vue.createCommentVNode("", true)
          ]),
        ...
        !_ctx.expandable || isOpen.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$m, [
          ...
          }, vue.toDisplayString((_f = (_e = (_d = _ctx.options) == null ? void 0 : _d.labels) == null ? void 0 : _e.clearAll) != null ? _f : ""), 1)
        ])) : vue.createCommentVNode("", true)
...
const _sfc_main$E = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["lupa-child-category-item", { "lupa-child-category-item-active": isActive.value }])
      }, [
        vue.createElementVNode("a", {
          "data-cy": "lupa-child-category-item",
          href: urlLink.value,
          onClick: handleNavigation
        }, vue.toDisplayString(title.value), 9, _hoisted_1$D)
      ], 2);
    };
  }
});
...
const _sfc_main$C = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const termFilter = vue.ref("");
    const emit = __emit;
    const itemLimit = vue.computed(() => {
    ...
    const displayShowMore = vue.computed(() => {
      return Boolean(
...
var m = { name: "Slider", emits: ["input", "update:modelValue", "start", "slide", "drag", "update", "change", "set", "end"], props: __spreadProps(__spreadValues({}, { value: { validator: function(e) {
  ...
  const l = function(r, i, n) {
    ...
    const c3 = vue.ref(l2.value);
    if (u(l2.value) && (l2 = vue.ref(s2.value)), Array.isArray(l2.value) && 0 == l2.value.length)
    ...
    const { format: o, step: a2 } = vue.toRefs(t), s2 = n.value, l2 = n.classList, u2 = vue.computed(() => o && o.value ? "function" == typeof o.value ? { to: o.value } : d(__spreadValues({}, o.value)) : d({ decimals: a2.value >= 0 ? 0 : 2 })), c3 = vue.computed(() => Array.isArray(s2.value) ? s2.value.map((e) => u2.value) : u2.value);
    ...
    return vue.onMounted(B), vue.onUnmounted(_), vue.watch(z, $, { immediate: false }), vue.watch(v, $, { immediate: false }), vue.watch(g, $, { immediate: false }), vue.watch(m3, $, { immediate: false }), vue.watch(c3, $, { immediate: false }), vue.watch(p3, $, { immediate: false }), vue.watch(d2, $, { immediate: false }), vue.watch(b, $, { immediate: false }), vue.watch(E, $, { immediate: false, deep: true }), vue.watch(x, $, { immediate: false, deep: true }), vue.watch(w, $, { immediate: false, deep: true }), vue.watch(k, (e, t) => {
      t && ("object" == typeof t && "object" == typeof e && e && Object.keys(t) > Object.keys(e) || "object" == typeof t && "object" != typeof e || u(e)) && $();
    }, { immediate: false }), vue.watch(k, (e) => {
      if (u(e))
...
const _sfc_main$B = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const isInputVisible = vue.computed(() => {
      var _a;
        ...
        !isInputVisible.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$q, vue.toDisplayString(statsSummary.value), 1)) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_3$j, [
          vue.createElementVNode("div", null, [
            ...
            vue.createElementVNode("div", _hoisted_5$9, [
              ...
              isPrice.value ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_7$3, vue.toDisplayString(currency.value), 1)) : vue.createCommentVNode("", true)
            ])
          ]),
          _hoisted_8,
          vue.createElementVNode("div", null, [
            ...
            vue.createElementVNode("div", _hoisted_10, [
              ...
              isPrice.value ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_12, vue.toDisplayString(currency.value), 1)) : vue.createCommentVNode("", true)
            ])
          ])
        ])),
...
const _sfc_main$A = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const emit = __emit;
    const showChildren = vue.computed(() => {
      var _a, _b;
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["lupa-facet-hierarchy", { "lupa-term-active": isChecked.value }])
      }, [
        vue.createElementVNode("div", {
        ...
        showChildren.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_5$8, [
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$y, [
        isFilterable.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$o, [
          vue.withDirectives(vue.createElementVNode("input", {
            class: "lupa-term-filter",
            "data-cy": "lupa-term-filter",
            "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => termFilter.value = $event),
...
const _sfc_main$y = /* @__PURE__ */ vue.defineComponent(__spreadProps(__spreadValues({}, __default__), {
  __name: "FacetDisplay",
  props: {
    options: {},
    facet: {},
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _cache) => {
      return hasItems.value ? (vue.openBlock(), vue.createElementBlock("div", {
        key: 0,
        ref_key: "facetPanel",
        ref: facetPanel,
        ...
        vue.createElementVNode("div", {
          class: vue.normalizeClass(["lupa-search-result-facet-label", { open: isOpen.value, "lupa-has-filter": hasFilter.value }]),
          "data-cy": "lupa-search-result-facet-label",
          onClick: toggleFacet
        }, [
          vue.createElementVNode("div", _hoisted_1$x, vue.toDisplayString(facet.value.label), 1),
          vue.createElementVNode("div", {
            class: vue.normalizeClass(["lupa-facet-label-caret", isOpen.value && "open"])
          }, null, 2)
        ], 2),
        isOpen.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$n, [
          ...
          _ctx.clearable ? (vue.openBlock(), vue.createElementBlock("div", {
            key: 0,
...
const _sfc_main$x = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit: __emit }) {
    ...
    const facetsValue = vue.computed(() => {
      var _a;
      return (_a = props.facets) != null ? _a : [];
    });
    const displayFacets = vue.computed(() => {
      return props.options.exclude ? facetsValue.value.filter((f2) => {
        var _a;
        return !((_a = props.options.exclude) == null ? void 0 : _a.includes(f2.key));
      }) : facetsValue.value;
    });
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$w, [
        _ctx.options.labels.title ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$m, vue.toDisplayString(_ctx.options.labels.title), 1)) : vue.createCommentVNode("", true),
        vue.createElementVNode("div", {
...
const _sfc_main$w = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const regularFacets = vue.computed(() => {
      var _a;
      return (_a = facets.value) == null ? void 0 : _a.filter((f2) => {
        var _a2;
        return !((_a2 = props.options.promotedFacets) == null ? void 0 : _a2.includes(f2.key));
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$v, [
        regularFacets.value ? (vue.openBlock(), vue.createBlock(_sfc_main$x, {
          ...
          currentFilters: vue.unref(filters),
...
const _sfc_main$v = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const currentFiltersVisible = vue.computed(() => {
      var _a, _b;
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$u, [
        showCurrentFilters.value ? (vue.openBlock(), vue.createBlock(_sfc_main$F, {
          key: 0,
          options: _ctx.options.currentFilters,
          expandable: (_a = _ctx.expandable) != null ? _a : false
        }, null, 8, ["options", "expandable"])) : vue.createCommentVNode("", true),
        _ctx.options.categories ? (vue.openBlock(), vue.createBlock(_sfc_main$D, {
          key: 1,
          options: _ctx.options.categories,
          ref_key: "categoryFilters",
          ref: categoryFilters
        }, null, 8, ["options"])) : vue.createCommentVNode("", true),
        _ctx.options.facets ? (vue.openBlock(), vue.createBlock(_sfc_main$w, {
          key: 2,
...
const _sfc_main$u = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const isFilterCountVisible = vue.computed(() => {
      var _a, _b;
    ...
    return (_ctx, _cache) => {
      return isMobileSidebarVisible.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$t, [
        vue.createElementVNode("div", {
        ...
        vue.createElementVNode("div", _hoisted_2$l, [
          vue.createElementVNode("div", _hoisted_3$g, [
            vue.createElementVNode("div", _hoisted_4$b, [
              ...
              isFilterCountVisible.value ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_5$7, vue.toDisplayString(vue.unref(currentFilterCount)), 1)) : vue.createCommentVNode("", true)
            ]),
            vue.createElementVNode("div", {
...
const _sfc_main$t = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const breadcrumbsValue = vue.computed(() => {
      var _a;
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$s, [
        (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(breadcrumbsValue.value, (breadcrumb, index) => {
          return vue.openBlock(), vue.createElementBlock("span", {
            ...
            breadcrumb.link ? (vue.openBlock(), vue.createElementBlock("a", {
              key: 0,
            ...
            }, vue.toDisplayString(getLabel(breadcrumb.label)), 9, _hoisted_2$k)) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_3$f, vue.toDisplayString(getLabel(breadcrumb.label)), 1)),
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$q, [
        vue.createElementVNode("div", {
          class: vue.normalizeClass([
            ...
            vue.unref(classMap).layoutSelectionGrid,
            vue.unref(layout) === "Grid" ? "lupa-layout-selection-active " + vue.unref(classMap).layoutSelectionGridActive : ""
          ]),
        ...
        vue.createElementVNode("div", {
          class: vue.normalizeClass([
            ...
            vue.unref(classMap).layoutSelectionList,
            vue.unref(layout) === "List" ? "lupa-layout-selection-active " + vue.unref(classMap).layoutSelectionListActive : ""
          ]),
...
const _sfc_main$q = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        class: vue.normalizeClass(["lupa-mobile-toggle", { "lupa-mobile-toggle-filters-empty": vue.unref(currentFilterCount) < 1 }]),
        onClick: handleMobileToggle
      }, [
        vue.createTextVNode(vue.toDisplayString(_ctx.label) + " ", 1),
        _ctx.showFilterCount && vue.unref(currentFilterCount) > 0 ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_1$p, vue.toDisplayString(vue.unref(currentFilterCount)), 1)) : vue.createCommentVNode("", true)
      ], 2);
    };
  }
});
...
const _sfc_main$p = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const lastPageLabel = vue.computed(() => {
      var _a;
      return (_a = props.lastPageLabel) != null ? _a : ">";
    });
    const firstPageLabel = vue.computed(() => {
      var _a;
    ...
    return (_ctx, _cache) => {
      return showPagination.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$o, [
        ...
        showFirstPage.value ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
          ...
          showFirstPageSeparator.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$j, "...")) : vue.createCommentVNode("", true)
          ...
          vue.withDirectives(vue.createElementVNode("select", {
            ...
            (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(sortItems.value, (option) => {
              return vue.openBlock(), vue.createElementBlock("option", {
                key: option.key,
                value: option.key
              }, vue.toDisplayString(option.label), 9, _hoisted_5$6);
            }), 128))
          ], 40, _hoisted_4$7), [
...
const _sfc_main$m = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const paginationDisplay = vue.computed(() => {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("div", _hoisted_1$l, [
          showLayoutSelection.value ? (vue.openBlock(), vue.createBlock(_sfc_main$r, { key: 0 })) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$g)),
          showItemSummary.value ? (vue.openBlock(), vue.createBlock(_sfc_main$I, {
            key: 2,
          ...
          displayPageSelect.value ? (vue.openBlock(), vue.createBlock(_sfc_main$p, {
            key: 4,
            options: paginationOptions.value.pageSelect,
            "last-page-label": paginationOptions.value.labels.showMore,
            "first-page-label": paginationOptions.value.labels.showLess
          }, null, 8, ["options", "last-page-label", "first-page-label"])) : (vue.openBlock(), vue.createElementBlock("div", _hoisted_4$6))
        ]),
        vue.createElementVNode("div", _hoisted_5$5, [
          ...
          paginationDisplay.value.pageSize ? (vue.openBlock(), vue.createBlock(_sfc_main$o, {
            key: 0,
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", null, [
        ...
        }, null, 8, _hoisted_3$a)) : vue.createCommentVNode("", true)
      ]);
    };
  }
});
...
const _sfc_main$k = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", null, [
        loading.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$j, "Loading...")) : vue.createCommentVNode("", true),
        error.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$e, vue.toDisplayString(error.value), 1)) : vue.createCommentVNode("", true),
        !loading.value && !error.value ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 2,
          innerHTML: rawHtml.value
...
const _sfc_main$j = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const paramsStore = useParamsStore();
    const { searchResult } = storeToRefs(searchResultStore);
    const similarQueries = vue.computed(() => searchResult.value.similarQueries);
...
const _sfc_main$i = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    vue.watch(searchString, () => handleQueryChange());
    ...
    return (_ctx, _cache) => {
      return hasResults.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$h, [
        ...
        displayShowMore.value ? (vue.openBlock(), vue.createElementBlock("div", {
          key: 0,
          class: vue.normalizeClass(["lupa-additional-panel-show-more", { "lupa-additional-panel-show-less": showAll.value }]),
          "data-cy": "lupa-additional-panel-show-more",
          onClick: toggleShowMore
        }, vue.toDisplayString(showAll.value ? addParams(_ctx.panel.labels.showLess, itemCount.value) : addParams(_ctx.panel.labels.showMore, itemCount.value)), 3)) : vue.createCommentVNode("", true)
      ])) : vue.createCommentVNode("", true);
    };
  }
});
...
const _sfc_main$h = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const locationPanels = vue.computed(() => {
      var _a, _b;
      return (_b = (_a = props.options.additionalPanels) == null ? void 0 : _a.filter((p2) => p2.location === props.location)) != null ? _b : [];
    });
...
const _sfc_main$g = {};
const _hoisted_1$f = { class: "loading-overlay active" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$e, [
        vue.createElementVNode("div", _hoisted_2$b, vue.toDisplayString(_ctx.labels.similarResultsLabel), 1),
...
const _sfc_main$e = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const currentFilterOptions = vue.computed(() => {
      var _a;
    ...
    const desktopFiltersExpanded = vue.computed(() => {
      var _a, _b, _c, _d, _e;
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", _hoisted_1$d, [
        ...
        vue.unref(hasResults) ? (vue.openBlock(), vue.createElementBlock(vue.Fragment, { key: 1 }, [
          showTopFilters.value ? (vue.openBlock(), vue.createBlock(_sfc_main$s, {
            key: 0,
            options: (_a = _ctx.options.filters) != null ? _a : {}
          }, null, 8, ["options"])) : vue.createCommentVNode("", true),
          showMobileFilters.value ? (vue.openBlock(), vue.createBlock(_sfc_main$m, {
            key: 1,
            class: "lupa-toolbar-mobile",
            options: _ctx.options,
            "pagination-location": "top"
          }, null, 8, ["options"])) : vue.createCommentVNode("", true),
          currentFilterOptions.value ? (vue.openBlock(), vue.createBlock(_sfc_main$F, {
            key: 2,
...
const _sfc_main$c = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const showFilterSidebar = vue.computed(() => {
      var _a, _b, _c;
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        _ctx.isContainer ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_1$b, [
          vue.createVNode(_sfc_main$J, { labels: didYouMeanLabels.value }, null, 8, ["labels"]),
          vue.createVNode(_sfc_main$H, {
            "show-summary": true,
            options: _ctx.options,
        ...
        _ctx.options.filters ? (vue.openBlock(), vue.createBlock(_sfc_main$u, {
          key: 2,
          options: _ctx.options.filters
        }, null, 8, ["options"])) : vue.createCommentVNode("", true),
        vue.unref(currentQueryText) || _ctx.isProductList ? (vue.openBlock(), vue.createBlock(_sfc_main$t, {
          key: 3,
        ...
        isTitleResultTopPosition.value ? (vue.openBlock(), vue.createElementBlock("div", _hoisted_2$8, [
          showFilterSidebar.value ? (vue.openBlock(), vue.createBlock(_sfc_main$v, {
            key: 0,
...
const _sfc_main$b = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const overviewVisible = vue.computed(() => {
      var _a, _b;
...
const _sfc_main$a = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const componentOptions = vue.computed(() => {
...
const _sfc_main$9 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const optionsStore = useOptionsStore();
    const searchResults = vue.ref(null);
    const searchBox = vue.ref(null);
    const fullSearchResultsOptions = vue.computed(() => {
    ...
    const fullSearchBoxOptions = vue.computed(() => {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        onClick: _cache[1] || (_cache[1] = vue.withModifiers(($event) => _ctx.$emit("close"), ["stop", "prevent"]))
      }, [
        vue.createElementVNode("div", {
...
const _sfc_main$8 = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const loading = vue.ref(true);
    const carouselOptions = vue.computed(() => {
      var _a;
      return (_a = props.options.carousel) != null ? _a : {};
    });
    const clickTrackingSettings = vue.computed(() => {
      return {
          ...
          vue.createVNode(vue.unref(Carousel), vue.mergeProps(carouselOptions.value, { "wrap-around": true }), {
            ...
            default: vue.withCtx(() => [
              (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(recommendations.value, (product, index) => {
                return vue.openBlock(), vue.createBlock(vue.unref(Slide), {
